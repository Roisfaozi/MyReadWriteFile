package com.raven.myreadwritefile
...
internal object FileHelper {
    ...
    fun readFromFile(context: Context, filename: String): FileModel {
        ...
        try {
            ...
            if (inputStream != null){
                val recieveString = inputStream.bufferedReader().use(BufferedReader::readText)
                inputStream.close()
                fileModel.data = recieveString
                fileModel.data = filename
            }
